...
exec $JAVA_BIN -jar /usr/share/jenkins/agent.jar -secret $JENKINS_SECRET -name $JENKINS_AGENT_NAME -tunnel $JENKINS_TUNNEL -url $JENKINS_URL -workDir $JENKINS_AGENT_WORKDIR &
exec "$@" 
